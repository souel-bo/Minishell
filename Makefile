...
LIBFT_SRC = libft/ft_lstaddback.c libft/ft_lstdelone.c libft/ft_lstnew.c libft/ft_strjoin.c libft/ft_strlcpy.c libft/ft_strndup.c \
            libft/ft_lstclear.c libft/ft_lstlast.c libft/ft_strchr.c libft/ft_strlcat.c libft/ft_strlen.c  libft/ft_itoa.c \
            libft/ft_putchar_fd.c libft/ft_putstr_fd.c libft/ft_strncmp.c libft/ft_split.c libft/ft_lstsize.c libft/ft_atoi.c \ libft/alphanum.c
